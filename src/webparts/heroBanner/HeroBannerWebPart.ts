          ...
          groups: [
            {
              ...
              groupFields: [
                PropertyPaneDropdown('libary', {
                  label: "Libary",
                  options: [
                    { key: 'selectanOption', text: 'Select an item' },
                    { key: 'libary1', text: 'Libary 1' },
                    { key: 'libary2', text: 'Libary 2', },
                    { key: 'libary3', text: 'Libary 3' },
                    { key: 'libary4', text: 'Libary 4' },
                  ], selectedKey: 'selectanOption'
